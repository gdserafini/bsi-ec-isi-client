...
if (!empty($_GET['search'])) {
    ...
    $sql = "SELECT id_tipo_residuo, nome, imagem, descricao, toxico
            FROM TipoResiduo
            WHERE nome LIKE '%$searchValue%' OR descricao LIKE '%$searchValue%' OR toxico LIKE '%$searchValue%'
            ORDER BY nome";
} else {
    $sql = "SELECT id_tipo_residuo, nome, imagem, descricao, toxico
...
<div class="container text-secondary">
    ...
    <div class="container text-bg-light rounded shadow-sm p-2 mb-5">
        ...
        if ($result = mysqli_query($conn, $sql)) {
            ...
            echo "<p>Nenhum tipo de resíduo encontrado.</p>";
        }
...
<script>
    ...
    function searchData() {
        ...
        window.location.href = 'sobre.php?search=' + search;
    }
</script>
</body>
</html>
