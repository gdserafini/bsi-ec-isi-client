                ...
                <a class="nav-link p-3" href="#" onclick="window.location.href='editarConta.php'">
                  <img src="../../resources/perfilIcon.png" alt="GreenPath" style="max-width: 35px;"></a>                 
						...
						<h2>Exclusão de <?php echo $row['nome']; ?></h2>
							...
							<p>
								<br>
							<input type="submit" value="Excluir Local" class="btn btn-secondary shadow-sm p-2 mb-5" >
							<input type="button" value="Cancelar" class="btn btn-danger shadow-sm p-2 mb-5" onclick="window.location.href='locais.php'"></p>
						</form>
			<?php 
					}else{?>
						<div class="container">
